...
import net.ymnaytka.gtac.common.data.materials.*;

public class GTACMaterials {
    ...
    public static Material SkyIron;
    public static Material TaintedGold;
    public static Material DepthIron;
    public static Material TwilightGold;
    public static Material FieryIron;
    public static Material LeafGold;
